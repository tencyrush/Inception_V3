...
def inception_v3_arg_scope(weight_decay=0.00004,
                           stddev=0.1, batch_norm_var_collection='moving_vars'):
    batch_norm_params = {
        'decay': 0.9997,
        'epsilon': 0.001,
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
            ...
            with tf.variable_scope('Mixed_5b'):
                ...
                with tf.variable_scope('Branch_3'):
                        ...
                        branch_3 = slim.conv2d(branch_3, 32, [1, 1],
                                               scope='Conv2d_0b_1x1')
                    #通道和为 64+64+96+32=256,输出35*35*256
                net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)

            #Inception_1_Module_2
            ...
            with tf.variable_scope('Mixed_6a'):
                ...
                with tf.variable_scope('Branch_2'):
                    ...
                    # 17*17*(384+96+256)=17*17*768
                net = tf.concat([branch_0, branch_1, branch_2], 3)

            # Inception_2_Module_2
            ...
            with tf.variable_scope('Mixed_7a'):
                ...
                with tf.variable_scope('Branch_2'):
                    ...
                    # 8*8*(320+192+768)=8*8*1280
                net = tf.concat([branch_0, branch_1, branch_2], 3)

            # Inception_3_Module_2
            with tf.variable_scope('Mixed_7b'):
                ...
                with tf.variable_scope('Branch_3'):
                    ...
                    branch_3 = slim.conv2d(branch_3, 192, [1, 1],
                                           scope='Conv2d_0b_1x1')
                    # 8*8*(320+768+768+192)=8*8*2048
                net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)

            # Inception_3_Module_3
...
def inception_v3(inputs,
                 ...
                 dropout_keep_prob=0.8,#Dropout所需保留节点的比例
